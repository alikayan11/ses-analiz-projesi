...
save_button = tk.Button(left_frame, text="Kaydet", command=save_data, bg="red", width=20)
save_button.pack(pady=5)

record_button = tk.Button(left_frame, text="Kayda Başla", command=start_recording, width=20)
record_button.pack(pady=5)

stop_button = tk.Button(left_frame, text="Kaydı Durdur", command=stop_recording, width=20)
stop_button.pack(pady=5)

# Sağ alttaki butonlar
list_button = tk.Button(right_frame, text="Listele", command=list_data, width=20)
list_button.pack(pady=5)

plot_button = tk.Button(right_frame, text="Dalga Formu ve Spektrogram Göster", command=display_waveform_and_spectrogram, width=20)
plot_button.pack(pady=5)

train_button = tk.Button(right_frame, text="Model Eğit ve Değerlendir", command=train_and_evaluate_model, width=20)
