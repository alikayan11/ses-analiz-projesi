...
name_label = tk.Label(app, text="Sahibin Adı:", bg="#e0f7fa")
name_label.pack(pady=5)
name_entry = tk.Entry(app, width=50)
name_entry.pack(pady=5)

file_label = tk.Label(app, text="Ses Dosyası:", bg="#e0f7fa")
...
save_button = tk.Button(left_frame, text="Kaydet", command=save_data, bg="#ff7070", width=20)
save_button.pack(pady=5)

record_button = tk.Button(left_frame, text="Kayda Başla", command=start_recording, bg="#f3e5f5", width=20)
record_button.pack(pady=5)

stop_button = tk.Button(left_frame, text="Kaydı Durdur", command=stop_recording, bg="#f3e5f5", width=20)
stop_button.pack(pady=5)

# Sağ alttaki butonlar
list_button = tk.Button(right_frame, text="Listele", command=list_data, bg="#f3e5f5", width=20)
list_button.pack(pady=5)

plot_button = tk.Button(right_frame, text="Dalga Formu ve Spektrogram Göster", command=display_waveform_and_spectrogram, bg="#f3e5f5", width=20)
plot_button.pack(pady=5)

train_button = tk.Button(right_frame, text="Model Eğit ve Değerlendir", command=train_and_evaluate_model, bg="#f3e5f5", width=20)
