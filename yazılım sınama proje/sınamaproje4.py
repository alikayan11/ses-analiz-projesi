...
# Butonları sol ve sağa hizalamak için Frame kullanımı
...
# Sol tarafa yerleştirilecek butonlar
save_button = tk.Button(left_frame, text="Kaydet", command=save_data, bg="red")
save_button.pack(pady=5)

record_button = tk.Button(left_frame, text="Kayda Başla", command=start_recording)
record_button.pack(pady=5)

stop_button = tk.Button(left_frame, text="Kaydı Durdur", command=stop_recording)
stop_button.pack(pady=5)

# Sağ tarafa yerleştirilecek butonlar
list_button = tk.Button(right_frame, text="Listele", command=list_data)
list_button.pack(pady=5)

plot_button = tk.Button(right_frame, text="Dalga Formu ve Spektrogram Göster", command=display_waveform_and_spectrogram)
plot_button.pack(pady=5)

train_button = tk.Button(right_frame, text="Model Eğit ve Değerlendir", command=train_and_evaluate_model)
