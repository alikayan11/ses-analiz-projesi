...
def speech_to_text():
    ...
    try:
        ...
        os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "yazilimsinama11-d7a69f6f7252.json"  # JSON dosyanızın yolu
        ...
        wrapper = textwrap.TextWrapper(width=67)  # 80 karakter genişliğinde satırlara böler
