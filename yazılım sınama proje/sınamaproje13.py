...
# Veritabanındaki verileri başka bir pencerede listelemek için fonksiyon
def list_data():
    def close_window():
        list_window.destroy()

    list_window = tk.Toplevel(app)
    list_window.title("Kayıtlı Ses Dosyaları")
    ...
    close_button = tk.Button(list_window, text="Kapat", command=close_window)
